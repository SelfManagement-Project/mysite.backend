...
public class SearchServiceImpl implements SearchService {
    ...
    @Override
    public List<Map<String, Object>> searchAllTables(String keyword) {
        // 1. DB에서 모든 테이블 목록 조회
        ...
        for (String tableName : tableNames) {
            ...
            if (columnNames.isEmpty()) continue; // 컬럼이 없으면 스킵

            // 3. 검색 실행
            List<Map<String, Object>> results = searchMapper.searchTable(tableName, keyword, columnNames);
            if (!results.isEmpty()) {
